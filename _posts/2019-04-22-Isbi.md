...
![](../Images/TNBC_pipeline.png){:class="img-responsive"}
...
![](../Images/tissue_encoding.png){:class="img-responsive"}
...
![](../Images/encoding_variance.png){:class="img-responsive"}
**Figure 4**: *Encoding variances for histological images* 

<ol type="a">
  <li>Input image</li>
  <li>Fliped input image by the *Flip* augmentation</li>
...
![](../Images/table_results_TNBC.png){:class="img-responsive"}
...
![](../Images/mitose_count.png){:class="img-responsive"}
**Figure 5**: *Mitotic index* 

![](../Images/cancer_count.png){:class="img-responsive"}
**Figure 6**: *Cancer cellularity* 

#### Two step model

![](../Images/2S_idea.png){:class="img-responsive"}
...
![](../Images/2S_practice.png){:class="img-responsive"}
...
#### One step model
one_step
![](../Images/one_step.png){:class="img-responsive"}
