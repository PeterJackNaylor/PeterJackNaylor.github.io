...
At the ISBI 2017 held in Melbourne, Australia I presented our conference paper *Nuclei Segmentation in Histopathology Images Using Deep Neural Networks*. The slides for the talk can be found [here](http://members.cbio.mines-paristech.fr/~pnaylor/Downloads/isbi_17_talk.pdf)
...
![](../Images/TNBC_dataset_example.png){:class="img-responsive"}
...
![](../Images/table_benchmark.png){:class="img-responsive"}
**Table 1**: *Metric comparaison of methods* 

![](../Images/VisualComparaisonBenchmark.png){:class="img-responsive"}
